# دليل بناء تطبيق Windows - WorkTrack Worker PWA
...
```
frontend-worker-pwa/dist-electron/
├── WorkTrack-Worker-1.0.0-x64.exe        # NSIS Installer
├── WorkTrack-Worker-1.0.0-x64-portable.exe # Portable Version
